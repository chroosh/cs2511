...
import unsw.enrolment.AvgCalculatedMark;
...
import unsw.enrolment.ManualMark;
import unsw.enrolment.Student;
import unsw.enrolment.SumCalculatedMark;
...
//        comp1511Enrolment.assignMark(65);
        ...
        // ass1 should be 10/20
        comp1511Enrolment.addManualMark("ass1", 20, 10);
        
        // TODO Give the student a passing mark for milestone 1 of assignment 2
        comp1511Enrolment.addManualMark("ms1", 20, 10);

        // TODO Give the student a passing mark for milestone 2 of assignment 2
        comp1511Enrolment.addManualMark("ms2", 20, 10);
        

        // TODO Give the student an assignment 2 mark which is the average of
        // milestone 1 and 2
        // should be 10/20
        String[] ass2Array = new String[]{"ms1", "ms2"};
        comp1511Enrolment.createAvgMark("ass2", ass2Array);

        // TODO Give the student a prac mark which is the sum of assignment 1
        // and 2
        // should be 10/20 + 10/20 = 20/40
        String[] pracArray = new String[]{"ass1", "ass2"};
        comp1511Enrolment.createSumMark("prac", pracArray);

        // TODO Give the student a passing exam mark.
        comp1511Enrolment.addManualMark("exam", 20, 10);

        comp1511Enrolment.assignGrade();
        
        // modify marks and log updates
        comp1511Enrolment.addManualMark("ass1", 20, 18);
        comp1511Enrolment.addManualMark("ms1", 20, 18);
        comp1511Enrolment.addManualMark("exam" , 20 , 12);
